...
function buildWhiteMoonlightImmersive(answer) {
  const script = [
    ...
    "changeFigure:fig-boy-him.png -left -enter=enter-from-left -next;",
    "label:start;",
    "旁白:她跟我从小一起长大。近到我家小院后门出去，到她家前门，就是两步。;",
    "旁白:大人们说，我们两人在襁褓的时候就天天见面。;",
    "changeFigure:fig-girl-her.png -right -enter=enter-from-right -next;",
    "她:哥哥，等等我。;",
    ...
    "changeFigure:fig-girl-her.png -right -next;",
    ...
    "changeFigure:fig-adult-him.png -left -next;",
    "changeFigure:fig-adult-her.png -right -next;",
