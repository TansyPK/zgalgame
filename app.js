...
function buildWhiteMoonlightImmersive(answer) {
  const script = [
    ...
    "changeBg:bg-courtyard.jpg -next;",
    "changeFigure:fig-boy-him-640.png -left -enter=enter-from-left -next;",
    "label:start;",
    "旁白:她跟我从小一起长大。近到我家小院后门出去，到她家前门，就是两步。;",
    "旁白:大人们说，我们两人在襁褓的时候就天天见面。;",
    "changeFigure:fig-girl-her-640.png -right -enter=enter-from-right -next;",
    "她:哥哥，等等我。;",
    ...
    "changeBg:bg-homework-room.jpg -next;",
    "我:走吧，今天先写语文，写完再出去玩。;",
    "她:那你不许自己先写完。;",
    ...
    "changeBg:bg-birthday-table.jpg -next;",
    ...
    "label:demolition;",
    "changeBg:bg-bus-stop.jpg -next;",
    "changeFigure:fig-girl-her-640.png -right -next;",
    "旁白:后来房子拆迁，我们分开了。可电话线和周末，把距离勉强缝了起来。;",
    "旁白:见面时我们还是手牵手。她比我早发育，初一时高我大半个头，也照牵不误。;",
    "她:以后我穿高跟鞋，你也扛得住吧？;",
    "我:等我长高再说。;",
    "她:那你快点长。我们一起出去，回头率不得惊人啊。;",
    "changeBg:bg-classroom-letter.jpg -next;",
    ...
    "旁白:她嘴上嫌弃，手却没有松开。;",
    "label:college;",
    "changeBg:bg-train-station.jpg -next;",
    "changeFigure:fig-adult-him-640.png -left -next;",
    "changeFigure:fig-adult-her-640.png -right -next;",
    ...
    "label:washing_bowl;",
    "changeBg:bg-kitchen.jpg -next;",
    "旁白:饭后，她在厨房洗碗。我帮她系好围裙。;",
    "我:要是这一辈子能这么下去，多好啊。;",
    "旁白:这句话我没有说出口，只在心里说了一遍。;",
    "changeBg:bg-night-bar.jpg -next;",
