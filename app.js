...
function buildWhiteMoonlightImmersive(answer) {
  const script = [
    ...
    "changeBg:bg-courtyard.png -next;",
    ...
    "changeBg:bg-homework-room.png -next;",
    "我:走吧，今天先写语文，写完再出去玩。;",
    "她:那你不许自己先写完。;",
    ...
    "changeBg:bg-birthday-table.png -next;",
    ...
    "changeBg:bg-classroom-letter.png -next;",
    ...
    "旁白:她嘴上嫌弃，手却没有松开。;",
    "label:college;",
    "changeBg:bg-train-station.png -next;",
    ...
    "label:washing_bowl;",
    "changeBg:bg-kitchen.png -next;",
    "旁白:饭后，她在厨房洗碗。我帮她系好围裙。;",
    "我:要是这一辈子能这么下去，多好啊。;",
    "旁白:这句话我没有说出口，只在心里说了一遍。;",
    "changeBg:bg-night-bar.png -next;",
